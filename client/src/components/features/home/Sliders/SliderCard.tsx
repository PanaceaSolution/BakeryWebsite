...
const SliderCard: React.FC<SliderCardProps> = ({ id, name, price, categoryImage ,slug}) => {
  return (
    ...
    >
      {/* Outer Circle */}
      <div className="w-[130px] h-[130px] sm:w-[150px] sm:h-[150px] md:w-[183px] md:h-[183px] mx-auto overflow-hidden rounded-full flex justify-center items-center border border-[#8C1C32]">
        {/* Inner Circle */}
